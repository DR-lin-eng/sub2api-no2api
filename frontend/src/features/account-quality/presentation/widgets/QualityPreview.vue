<template>
  <div class="flex aspect-[4/3] w-full items-center justify-center overflow-hidden rounded-lg bg-slate-50 dark:bg-dark-900">
    <img v-if="hasPreview(point) && !failed" :src="previewURL(point)" :alt="t('common.accountQuality.preview')" class="h-full w-full object-contain" loading="lazy" @error="failed = true" />
