    ...
    <teleport to="body">
      <transition name="modal">
        ...
        >
          ...
          <div class="relative max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white p-6 shadow-2xl dark:bg-dark-800">
            <button
              type="button"
            ...
            <h2 class="mb-1 pr-8 text-lg font-bold text-gray-900 dark:text-white">
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <a :href="part.url" class="btn btn-secondary btn-xs shrink-0" rel="noopener">
