<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.oauth_quota" class="w-44" :options="qOpts" @update:model-value="updateOAuthQuota" @change="$emit('change')" />
...
const updateOAuthQuota = (value: string | number | boolean | null) => { emit('update:filters', { ...props.filters, oauth_quota: value }) }
...
const qOpts = computed(() => [
  ...
  { value: 'exhausted', label: t('admin.accounts.oauthQuotaExhausted') }
])
