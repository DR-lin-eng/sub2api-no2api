...
const messages: Record<string, string> = {
  ...
  'dashboard.day': 'Day',
  'dashboard.hour': 'Hour',
  'keys.columnSettings': 'Columns',
  'usage.group': 'Group',
  'usage.billingType': 'Billing type',
  'usage.billingMode': 'Billing mode',
  'usage.allTypes': 'All types',
  'usage.allBillingTypes': 'All billing types',
  'usage.billingTypeBalance': 'Balance',
  'usage.billingTypeSubscription': 'Subscription',
  'usage.allBillingModes': 'All billing modes',
  'usage.billingModeToken': 'Token',
  'usage.billingModePerRequest': 'Per request',
  'usage.billingModeImage': 'Image',
  'usage.billingModeVideo': 'Video',
