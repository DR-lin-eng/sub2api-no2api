...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'antigravity': return 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400'
      ...
      case 'kimi': return 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300'
      case 'zhipu': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300'
      case 'deepseek': return 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300'
      case 'minimax': return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'antigravity': return 'text-purple-700 dark:text-purple-400'
      ...
      case 'kimi': return 'text-pink-700 dark:text-pink-300'
      case 'zhipu': return 'text-indigo-700 dark:text-indigo-300'
      case 'deepseek': return 'text-cyan-700 dark:text-cyan-300'
      case 'minimax': return 'text-rose-700 dark:text-rose-300'
      case 'opencode_go': return 'text-amber-700 dark:text-amber-300'
    default: return ''
  }
}
