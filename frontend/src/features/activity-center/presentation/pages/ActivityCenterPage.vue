            ...
            <div class="lg:w-48">
              <div>
                ...
                <select v-model="typeFilter" class="input">
                  ...
                  <option value="checkin">{{ t('activityCenter.types.checkin') }}</option>
            ...
            >
              <div class="aspect-[16/9] overflow-hidden rounded-xl bg-gray-100 dark:bg-dark-800">
                <div
                  ...
                  v-html="safeBanners[campaign.id]"
                ></div>
...
import { sanitizeActivityBannerHtml } from '../activityHtml'
...
const safeBanners = computed(() => Object.fromEntries(campaigns.value.map(campaign => [campaign.id, sanitizeActivityBannerHtml(campaign.banner_html)])))
