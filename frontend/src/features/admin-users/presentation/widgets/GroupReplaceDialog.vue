...
import { replaceGroup } from '@/features/admin-users/data/datasources/adminUsersDatasource'
...
const handleReplace = async () => {
  ...
  try {
    const result = await replaceGroup(props.user.id, props.oldGroup.id, selectedGroupId.value)
