          ...
          <template #cell-user="{ row }">
            <div class="flex items-center gap-2">
              ...
              <RouterLink
                ...
                class="rounded font-medium text-gray-900 hover:text-primary-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 dark:text-white dark:hover:text-primary-400"
              >
                {{ userColumnMode === 'email'
