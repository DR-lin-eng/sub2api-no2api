...
declare module 'vue-router' {
  interface RouteMeta {
    ...
    /**
     * Whether this route requires activity center to be enabled.
     * @default false
     */
    requiresActivityCenter?: boolean

    /**
     * Whether this route requires the IPv6 egress management UI to be enabled.
     * @default false
     */
    requiresIPv6Egress?: boolean
