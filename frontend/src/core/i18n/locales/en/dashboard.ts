export default {
  ...
  keys: {
    ...
    groupBindings: {
      ...
      rateProtectionFor: 'Rate ceiling for {group}',
      unlimited: 'Unlimited',
      addGroup: 'Add group',
      orderHint: 'When multiple groups provide the same model, they are tried in this order. Groups above their rate ceiling are skipped.',
      subscriptionSingleHint: 'Subscription groups cannot currently be combined with other groups.',
      dragToReorder: 'Drag to change priority',
      moveUp: 'Move up',
      moveDown: 'Move down',
      removeGroup: 'Remove group',
      invalidRateProtection: 'Rate ceiling must be empty or greater than 0',
      primary: 'Primary',
      fallback: 'Fallback',
      fallbackPosition: 'Fallback {position}',
      singleGroup: 'No fallback groups configured',
      notConfigured: 'No routing groups',
      configure: 'Configure',
      manage: 'Manage',
      manageFor: 'Manage routing groups for {name}',
      manageEmpty: 'No routing groups configured',
      moreGroups: '+{count}',
      rateCeilingShort: '≤{rate}x',
      dialogTitle: 'Manage Routing Groups',
      dialogDescription: 'Configure routing priority and acceptable rate ceilings for "{name}".',
      groupCount: '{count} groups',
      currentPrimary: 'Current primary: {group}',
      save: 'Save groups',
      updatedSuccess: 'Routing groups updated',
      updateFailed: 'Failed to update routing groups',
    },
  ...
  usage: {
    ...
    timingComparison: 'Timing comparison',
    timingLocal: 'Local',
    timingFirstSource: 'Displayed TTFT source',
    timingDurationSource: 'Displayed duration source',
    timingLocalFirst: 'Local TTFT',
    timingLocalDuration: 'Local duration',
    timingEngineFirst: 'OpenAI engine TTFT',
    timingUpstreamDuration: 'OpenAI turn duration',
    timingFirstDifference: 'TTFT difference (local - OpenAI)',
    timingDurationDifference: 'Duration difference (local - OpenAI)',
    timingSampledFirst: 'OpenAI sampling TTFT',
    timingQueue: 'OpenAI max queue time',
    timingAPIDuration: 'OpenAI API duration (excluding client tools)',
    timingEngineCalls: 'OpenAI engine calls',
