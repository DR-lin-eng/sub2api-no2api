export default {
  promptAudit: {
    ...
    common: { actions: 'Actions', never: 'Never', unknown: 'Unknown' },
    mode: { off: 'Off', async_audit: 'Async audit only', blocking: 'Synchronous audit and block', unknown: 'Unknown' },
    status: { disabled: 'Disabled', running: 'Running', degraded: 'Degraded', error: 'Error', healthy: 'Healthy', failed: 'Failed', stale: 'Stale heartbeat', unknown: 'Unknown' },
    ...
    runtime: {
      ...
      queue: 'Active jobs / capacity', dependencies: 'Dependencies', dependenciesValue: 'DB {database} · Redis {redis}', guardMetrics: 'Synchronous Guard metrics', latest: 'Latest processing and error',
      dependencyStatus: { ok: 'OK', error: 'Error', unavailable: 'Unavailable', unknown: 'Unknown' },
