export default {
    ops: {
      ...
      networkBandwidth: {
        title: 'Public Network Bandwidth',
        publicScope: 'Global metric for the system default public-route interfaces only.',
        interfaces: 'Interfaces: {names}',
        receive: 'Receive (inbound)',
        transmit: 'Transmit (outbound)',
        currentReceive: 'Current receive',
        currentTransmit: 'Current transmit',
        peakCombined: 'Peak combined',
        empty: 'No public bandwidth samples yet. Two consecutive minute samples are required after startup; other interfaces are not aggregated when the default public route cannot be identified.'
      },
      ...
      settings: {
        ...
        displayNetworkBandwidth: 'Show Public Network Bandwidth',
        displayNetworkBandwidthHint: 'When disabled, receive and transmit trends for the default public-route interfaces are not queried.',
      ...
      concurrency: {
        ...
        sessionGrowthTotal: 'Session ID total {count}/min',
        sessionGrowthMax: 'Peak {count}/min',
        sessionGrowthPerMinute: 'Session ID {count}/min',
      ...
      tooltips: {
        ...
        networkBandwidth: 'Public ingress and egress rates for the current collector instance. Only interfaces selected by the default IPv4/IPv6 routes are counted and deduplicated; loopback, container bridges, and other private interfaces are excluded.',
