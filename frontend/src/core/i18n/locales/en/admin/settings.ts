...
export default {
    settings: {
      ...
      permissionGroups: {
        catalog: {
          support_read: { name: "Support: read", description: "View conversations, messages and unread counts" },
          support_write: { name: "Support: respond", description: "Reply, upload, recall, mark conversations and manage assets" },
          support_balance_transfer: { name: "Support: balance transfer", description: "Transfer balance to a user in a support conversation" },
          users_read_basic: { name: "Users: basic profile", description: "View a support user profile without keys or login identities" },
          users_manage: { name: "Users: manage", description: "List, create, edit and delete regular users; sensitive fields require additional grants" },
        ...
        builtIn: 'Built-in permission group',
        save: 'Save permission groups',
      ...
      streamTimeout: {
        ...
        openAIStartupTitle: 'OpenAI Responses startup protection',
        openAIStartupDescription: 'Keep pre-output retries safe and maintain the same client connection while an account is switched. Set 0 to disable a limit.',
        firstOutputTimeout: 'First semantic output (seconds)',
        firstOutputTimeoutHint: 'Standard requests. 90 seconds by default; 0 disables the deadline.',
        highEffortFirstOutputTimeout: 'High-effort output (seconds)',
        highEffortFirstOutputTimeoutHint: 'Used for high, xhigh and max reasoning. 0 reuses the standard value.',
        keepaliveInterval: 'SSE keepalive interval (seconds)',
        keepaliveIntervalHint: 'Comments sent while waiting or switching accounts. 0 disables keepalives.',
