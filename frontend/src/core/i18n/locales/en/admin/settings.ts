export default {
    settings: {
      ...
      features: {
        ...
        mediaStudio: {
          title: 'Media Studio',
          description: 'Controls the user Media Studio entry. The page is currently a preview shell for future image and video generation and is disabled by default.',
          enabled: 'Show Media Studio',
