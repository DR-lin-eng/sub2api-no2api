export default {
  common: {
    ...
    accountQuality: {
      passRate: "24h pass rate",
      classified: "graded checks",
      ...
      conversations: "Conversations & artwork",
      evidenceHint: "Actual answers, conversation IDs and previews · up to 200 records from the last 24 hours",
      filter: "Filter",
      all: "All records",
      images: "Artwork",
      loadMore: "Load more",
      details: "View check details",
      conversationId: "Conversation ID",
      responseId: "Response ID",
      runId: "Check ID",
      idUnavailable: "Conversation ID not returned",
      answer: "Answer",
      noAnswer: "No answer available",
      noStage: "Stage not run, or details not retained for this older record",
      stage1: "Stage 1 · Text question",
      stage2: "Stage 2 · Drawing",
      preview: "Animation generated by this check",
      noPreview: "No image available for this record",
      enlarge: "Enlarge image and view conversation",
      truncated: "Long answer: only the first 16 KiB is retained and shown.",
      codeMatchScore: 'Code match {score}/100 · threshold {threshold}',
      modelAMatched: 'Model A matched',
      modelANotMatched: 'Model A not matched',
      modelANormal: 'Match is normal',
      otherNormal: 'No match is normal',
      codeMatchHint: 'This score measures similarity in the generated code structure.',
      ...
      outputInterrupted: 'Output was interrupted; the analysis may be inaccurate.',
      ...
      poolProtectionTitle: 'Degraded accounts are removed from the normal pool',
      poolProtectionDescription: 'Account-level quality checks run continuously. After an account reaches the consecutive-failure action threshold, it is moved to an isolation group and stops serving normal traffic. It returns to its original pool only after meeting the recovery policy.',
      redBarTitle: 'A red bar means this account-level quality check did not pass',
      redBarDescription: 'Each bar represents one account-level check record. Red does not mean a site-wide outage or that your request is using that account. Multiple red records may belong to the same account, so the number of red bars is not the number of affected accounts.',
      ...
      degraded: 'Degraded', degradedNote: 'text or drawing check failed', uncertain: 'Uncertain', uncertainNote: 'insufficient evidence',
      errors: 'Request errors', errorsNote: 'excluded from classification', timeline: '24-hour quality timeline', timelineNote: 'Each bar is one account check · Select it to view evidence',
      empty: 'No public quality results', normal: 'Normal', abnormal: 'Quality check failed', waiting: 'Uncertain', failed: 'Request error',
