export default {
    ops: {
      ...
      networkBandwidth: {
        title: '公网出入网带宽',
        publicScope: '全局指标，仅统计系统默认公网路由接口。',
        interfaces: '接口：{names}',
        receive: '接收（下行）',
        transmit: '发送（上行）',
        currentReceive: '当前接收',
        currentTransmit: '当前发送',
        peakCombined: '窗口峰值（合计）',
        empty: '暂无公网带宽样本。服务启动后需连续采集两个分钟样本；无法确认默认公网路由时不会汇总其他网卡。'
      },
      ...
      settings: {
        ...
        displayNetworkBandwidth: '展示公网出入网带宽',
        displayNetworkBandwidthHint: '关闭后不查询默认公网路由接口的接收和发送速率趋势。',
      ...
      concurrency: {
        ...
        totalRows: '共 {count} 项',
        sessionGrowthTotal: 'Session ID 总增速 {count}/分钟',
        sessionGrowthMax: '最大增速 {count}/分钟',
        sessionGrowthPerMinute: 'Session ID {count}/分钟',
      ...
      tooltips: {
        ...
        networkBandwidth: '当前采集实例的公网出入网速率。只统计默认 IPv4/IPv6 路由对应接口，按接口名去重，不包含回环、容器桥接或其他内网网卡。',
