...
const messages: Record<string, string> = {
  ...
  'dashboard.spendingRankingTitle': 'User Spending Ranking',
  'dashboard.viewModelDistribution': 'Model Distribution',
  'dashboard.viewSpendingRanking': 'User Spending Ranking',
  'dashboard.spendingRankingUser': 'User',
  'dashboard.spendingRankingRequests': 'Requests',
  'dashboard.spendingRankingTokens': 'Tokens',
  'dashboard.spendingRankingSpend': 'Spend',
  'dashboard.spendingRankingOther': 'Others',
