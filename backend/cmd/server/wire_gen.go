...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cpaSyncService := service.NewCPASyncService(accountRepository, adminService, configConfig, db, compositeTokenCacheInvalidator)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, cpaSyncService)
