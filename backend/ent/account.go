...
type Account struct {
	...
	// Account outbound mode: inherit | direct | external_proxy | ipv6_pool.
...
type AccountEdges struct {
	...
	// EgressBinding holds the value of the egress_binding edge.
	EgressBinding *AccountEgressBinding `json:"egress_binding,omitempty"`
...
// EgressBindingOrErr returns the EgressBinding value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e AccountEdges) EgressBindingOrErr() (*AccountEgressBinding, error) {
	if e.EgressBinding != nil {
		return e.EgressBinding, nil
	} else if e.loadedTypes[2] {
		return nil, &NotFoundError{label: accountegressbinding.Label}
	}
	return nil, &NotLoadedError{edge: "egress_binding"}
}
...
// QueryEgressBinding queries the "egress_binding" edge of the Account entity.
func (_m *Account) QueryEgressBinding() *AccountEgressBindingQuery {
	return NewAccountClient(_m.config).QueryEgressBinding(_m)
}
...
func (_m *Account) String() string {
	...
	builder.WriteString(_m.EgressMode)
	builder.WriteString(", ")
