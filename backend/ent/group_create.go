...
func (_c *GroupCreate) SetIsDistillationGroup(v bool) *GroupCreate {
	_c.mutation.SetIsDistillationGroup(v)
	return _c
}

// SetNillableIsDistillationGroup sets the "is_distillation_group" field if the given value is not nil.
func (_c *GroupCreate) SetNillableIsDistillationGroup(v *bool) *GroupCreate {
	if v != nil {
		_c.SetIsDistillationGroup(*v)
	}
	return _c
}
...
func (_c *GroupCreate) defaults() error {
	...
	if _, ok := _c.mutation.IsDistillationGroup(); !ok {
		v := group.DefaultIsDistillationGroup
		_c.mutation.SetIsDistillationGroup(v)
	}
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.IsDistillationGroup(); !ok {
		return &ValidationError{Name: "is_distillation_group", err: errors.New(`ent: missing required field "Group.is_distillation_group"`)}
	}
	if _, ok := _c.mutation.ModelRoutingEnabled(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IsDistillationGroup(); ok {
		_spec.SetField(group.FieldIsDistillationGroup, field.TypeBool, value)
		_node.IsDistillationGroup = value
	}
...
// SetIsDistillationGroup sets the "is_distillation_group" field.
func (u *GroupUpsert) SetIsDistillationGroup(v bool) *GroupUpsert {
	u.Set(group.FieldIsDistillationGroup, v)
	return u
}

// UpdateIsDistillationGroup sets the "is_distillation_group" field to the value that was provided on create.
func (u *GroupUpsert) UpdateIsDistillationGroup() *GroupUpsert {
	u.SetExcluded(group.FieldIsDistillationGroup)
	return u
}
...
// SetIsDistillationGroup sets the "is_distillation_group" field.
func (u *GroupUpsertOne) SetIsDistillationGroup(v bool) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetIsDistillationGroup(v)
	})
}

// UpdateIsDistillationGroup sets the "is_distillation_group" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateIsDistillationGroup() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateIsDistillationGroup()
	})
}
...
// SetIsDistillationGroup sets the "is_distillation_group" field.
func (u *GroupUpsertBulk) SetIsDistillationGroup(v bool) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetIsDistillationGroup(v)
	})
}
...
// UpdateIsDistillationGroup sets the "is_distillation_group" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateIsDistillationGroup() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateIsDistillationGroup()
	})
}
