...
func TestAdminAPIKeyScopePolicy(t *testing.T) {
	...
	checks := []struct {
		...
		{http.MethodGet, "/api/v1/admin/settings/oauth-401-cleanup", []string{service.AdminAPIKeyScopeSettingsRead}, true},
		{http.MethodPut, "/api/v1/admin/settings/oauth-401-cleanup", []string{service.AdminAPIKeyScopeSettingsRead}, false},
		{http.MethodPut, "/api/v1/admin/settings/oauth-401-cleanup", []string{service.AdminAPIKeyScopeSettingsWrite}, true},
