...
func registerEgressRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	egress := admin.Group("/egress")
	{
		...
		egress.GET("/prefixes", h.Admin.Egress.DiscoverPrefixes)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/sync/cpa/preview", h.Admin.Account.PreviewFromCPA)
		accounts.POST("/sync/cpa", h.Admin.Account.SyncFromCPA)
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.POST("/accounts/quota/refresh/batch", h.Admin.OpenAIOAuth.RefreshQuotaBatch)
