...
func isCNProviderPlatform(platform string) bool {
	return service.IsCNProvider(strings.ToLower(strings.TrimSpace(platform)))
}
...
func openAICompatibleRequestPlatform(ctx context.Context, apiKey *service.APIKey) string {
	...
	if apiKey != nil && apiKey.Group != nil &&
		(apiKey.Group.Platform == service.PlatformGrok || service.IsCNProvider(apiKey.Group.Platform)) {
