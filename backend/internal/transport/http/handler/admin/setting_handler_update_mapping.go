...
func buildSystemSettingsUpdate(prepared *preparedSettingsUpdate) *service.SystemSettings {
	...
	return &service.SystemSettings{
		...
		OpenAIOAuthGatewayRateLimitEnabled:                 boolValueOrDefault(req.OpenAIOAuthGatewayRateLimitEnabled, previousSettings.OpenAIOAuthGatewayRateLimitEnabled),
		OpenAIOAuthGatewayRateLimitRPM:                     intValueOrDefault(req.OpenAIOAuthGatewayRateLimitRPM, previousSettings.OpenAIOAuthGatewayRateLimitRPM),
		OpenAIOAuthGatewayRateLimitBurst:                   intValueOrDefault(req.OpenAIOAuthGatewayRateLimitBurst, previousSettings.OpenAIOAuthGatewayRateLimitBurst),
		OpenAIRequestIntegrityObserveEnabled:               boolValueOrDefault(req.OpenAIRequestIntegrityObserveEnabled, previousSettings.OpenAIRequestIntegrityObserveEnabled),
