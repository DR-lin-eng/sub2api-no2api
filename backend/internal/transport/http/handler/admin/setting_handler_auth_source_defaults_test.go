...
func TestSettingHandler_UpdateSettings_PersistsPaymentVisibleMethodsAndAdvancedScheduler(t *testing.T) {
	...
	require.Equal(t, "true", repo.values[service.SettingKeyOpenAIContentSessionBurstBalanceEnabled])
	...
	require.Equal(t, true, data["openai_content_session_burst_balance_enabled"])
