...
func buildSettingsUpdateResponsePayload(
	...
	return dto.SystemSettings{
		...
		OpenAIOAuthGatewayRateLimitEnabled:                     updatedSettings.OpenAIOAuthGatewayRateLimitEnabled,
		OpenAIOAuthGatewayRateLimitRPM:                         updatedSettings.OpenAIOAuthGatewayRateLimitRPM,
		OpenAIOAuthGatewayRateLimitBurst:                       updatedSettings.OpenAIOAuthGatewayRateLimitBurst,
