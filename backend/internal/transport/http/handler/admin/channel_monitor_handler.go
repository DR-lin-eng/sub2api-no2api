...
type channelMonitorCreateRequest struct {
	...
	Provider         string            `json:"provider" binding:"required,oneof=openai anthropic gemini grok kimi zhipu deepseek minimax opencode_go"`
...
type channelMonitorUpdateRequest struct {
	...
	Provider         *string            `json:"provider" binding:"omitempty,oneof=openai anthropic gemini grok kimi zhipu deepseek minimax opencode_go"`
	MonitorMode      *string            `json:"monitor_mode" binding:"omitempty,oneof=active passive"`
	ChannelID        *int64             `json:"channel_id" binding:"omitempty,min=1"`
