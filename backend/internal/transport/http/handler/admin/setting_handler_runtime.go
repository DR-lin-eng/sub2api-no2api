...
func (h *SettingHandler) GetRateLimit429CooldownSettings(c *gin.Context) {
	...
	response.Success(c, dto.RateLimit429CooldownSettings{
		...
		AutoEnableAfterQuotaResetEnabled:    settings.AutoEnableAfterQuotaResetEnabled,
		AutoEnableWhenQuotaAvailableEnabled: settings.AutoEnableWhenQuotaAvailableEnabled,
	})
}
...
func (h *SettingHandler) UpdateRateLimit429CooldownSettings(c *gin.Context) {
	...
	autoEnableAfterReset := current.AutoEnableAfterQuotaResetEnabled
	if req.AutoEnableAfterQuotaResetEnabled != nil {
		autoEnableAfterReset = *req.AutoEnableAfterQuotaResetEnabled
	}
	autoEnableWhenAvailable := current.AutoEnableWhenQuotaAvailableEnabled
	if req.AutoEnableWhenQuotaAvailableEnabled != nil {
		autoEnableWhenAvailable = *req.AutoEnableWhenQuotaAvailableEnabled
	}
	...
	settings := &service.RateLimit429CooldownSettings{
		...
		AutoEnableAfterQuotaResetEnabled:    autoEnableAfterReset,
		AutoEnableWhenQuotaAvailableEnabled: autoEnableWhenAvailable,
	}
	...
	response.Success(c, dto.RateLimit429CooldownSettings{
		...
		AutoEnableAfterQuotaResetEnabled:    updatedSettings.AutoEnableAfterQuotaResetEnabled,
		AutoEnableWhenQuotaAvailableEnabled: updatedSettings.AutoEnableWhenQuotaAvailableEnabled,
	})
}
