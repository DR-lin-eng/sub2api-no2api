...
var DefaultAntigravityModelMapping = map[string]string{
	...
	"claude-sonnet-4-5":          "claude-sonnet-4-5", // explicit canonical selection passes through
	"claude-sonnet-4-5-thinking": "claude-sonnet-4-6", // legacy compatibility alias
	// Claude 详细版本 ID 映射
	"claude-opus-4-5-20251101":   "claude-opus-4-6-thinking", // 迁移旧模型
	"claude-sonnet-4-5-20250929": "claude-sonnet-4-6",        // legacy versioned ID
