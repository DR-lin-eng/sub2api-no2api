...
//
// Run with: go test -v -tags=integration ./internal/shared/tlsfingerprint/...
...
// Run with: go test -v -tags=integration -run TestAllProfiles ./internal/shared/tlsfingerprint/...
