...
const (
	...
	// OpenAIImagesEndpoint distinguishes the dedicated /v1/images/* ingress
	// from image intent inferred on text endpoints.
	OpenAIImagesEndpoint Key = "ctx_openai_images_endpoint"

	// Group 认证后的分组信息，由 API Key 认证中间件设置
	Group Key = "ctx_group"

	// APIKeyGroupRouting carries request-local ordered group routing state.
	APIKeyGroupRouting Key = "ctx_api_key_group_routing"
