...
func TestLoadGatewayCodexSimulationDefaults(t *testing.T) {
	...
	require.False(t, cfg.Gateway.CodexSimulation.CLevelSimulationEnabled)
	require.False(t, cfg.Gateway.CodexSimulation.ExperimentalTransportEnabled)
...
func TestLoadGatewayCodexSimulationFromEnvironment(t *testing.T) {
	...
	t.Setenv("GATEWAY_CODEX_SIMULATION_C_LEVEL_SIMULATION_ENABLED", "true")
	t.Setenv("GATEWAY_CODEX_SIMULATION_EXPERIMENTAL_TRANSPORT_ENABLED", "true")
	...
	require.True(t, cfg.Gateway.CodexSimulation.CLevelSimulationEnabled)
	require.True(t, cfg.Gateway.CodexSimulation.ExperimentalTransportEnabled)
