...
const (
	...
	// BillingModelSourceResponse uses a safe model declaration observed in the
	// successful upstream response. It is distinct from "upstream", which is the
...
// ChannelTimePricing describes recurring daily multiplier periods in an IANA
// timezone. Periods are left-closed/right-open; an end time of 00:00 denotes
