...
// system/developer prompt prefix, instructions (Responses API), and the first
// user message. System messages appended after the first user turn are
// deliberately ignored because clients commonly add dynamic context there.
