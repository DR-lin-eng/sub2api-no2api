...
func (m *opsRepoMock) GetUserUsageStats(ctx context.Context, filter *OpsUserUsageStatsFilter) (*OpsUserUsageStatsResponse, error) {
	return &OpsUserUsageStatsResponse{}, nil
}
