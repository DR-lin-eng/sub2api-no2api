...
func writeGatewaySystemSettingUpdates(updates map[string]string, settings *SystemSettings) error {
	...
	updates[SettingKeyOpenAIOAuthGatewayRateLimitEnabled] = strconv.FormatBool(settings.OpenAIOAuthGatewayRateLimitEnabled)
	updates[SettingKeyOpenAIOAuthGatewayRateLimitRPM] = strconv.Itoa(settings.OpenAIOAuthGatewayRateLimitRPM)
	updates[SettingKeyOpenAIOAuthGatewayRateLimitBurst] = strconv.Itoa(settings.OpenAIOAuthGatewayRateLimitBurst)
