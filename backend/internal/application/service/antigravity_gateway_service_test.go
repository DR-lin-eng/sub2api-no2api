...
func TestAntigravityGatewayServiceForwardGeminiFallbackReportsActualUpstreamModel(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	account := &Account{
		ID: 9, Name: "fallback", Platform: PlatformAntigravity, Type: AccountTypeOAuth, Status: StatusActive, Concurrency: 1,
		Credentials: map[string]any{
			"access_token": "token", "project_id": "proj",
			"model_mapping": map[string]any{originalModel: mappedModel},
		},
	}
