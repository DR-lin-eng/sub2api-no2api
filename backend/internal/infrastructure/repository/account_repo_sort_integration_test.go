		...
		Extra: map[string]any{
			service.UpstreamBillingProbeExtraKey: map[string]any{
				...
				"data": map[string]any{
					...
					"timezone":                  timezone,
					service.UpstreamBillingProbeSortMetadataVersionKey: service.UpstreamBillingProbeSortMetadataVersion,
					service.UpstreamBillingProbePeakStartMinuteKey:     minute - 2,
					service.UpstreamBillingProbePeakEndMinuteKey:       minute + 3,
				},
			},
		},
	})
