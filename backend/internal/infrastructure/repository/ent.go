...
// initializeDatabaseWithRetry retries only transient PostgreSQL startup and
// connection-class errors. Configuration, migration and data errors remain
// fail-fast so bounded recovery cannot mask an operator action.
