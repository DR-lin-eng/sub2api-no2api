...
| `account-quality-renderer/` | Optional legacy private SVG/HTML preview renderer for the public account-quality dashboard; quality verdicts use embedded HTML/SVG code matching |
| `../docs/FRONTEND_CORS_DEPLOYMENT_CN.md` | 二开前端同源部署、精确 CORS、iframe/sandbox 与发布验收指南 |
